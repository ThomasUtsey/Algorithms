...
# #     print([(files[k], k) for k in files])
# #     for i in files:
# #         for j in files:
# #         if files[i] == files [j]
# #         print
...
# # should print Ava, Emma, Olivia, Sophiaddd


# # 1. Write a Python program to print the following string
# # in a specific format (see the output).
...
print(f"the radius is {radius}, and the area is {area}")
...
a_tuple = ()
while not_quit:
    num = input("Enter a number or press q")
    a_list.append(num)
